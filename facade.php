...
class CPU
{
    public function freeze() {echo "CPU freezed!<br>";}
    public function jump($position) {echo "CPU jumped to $position!<br>";}
    public function execute() {echo "CPU executed!<br>";}
}
...
class Memory
{
    ...
    public function load($position, $data) {echo "Memory lodaed on position $position!<br>";}
}
...
class HardDrive
{
    ...
    public function read($lba, $size) {echo "HD readed sector $lba with size of $size byte!<br>";}
}
